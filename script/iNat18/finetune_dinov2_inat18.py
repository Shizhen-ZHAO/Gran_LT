...
def run_dinov2_inat18():
    T = Trainer()
    T.task = 'run_dinov2_inat18_lr3.5e5'
    T.note = 'run_dinov2_inat18_lr3.5e5'
...
# def run_dinov2_inat18_1():
#     T = Trainer()
#     T.task = 'run_dinov2_inat18_bs64_lr4375'
#     T.note = 'run_dinov2_inat18_bs64_lr4375'
#     T.ckpt = '/home/szzhao/pretrained_models/dinov2_vitb14_pretrain.pth'
#
#     T.dataset = 'iNat18'
#     T.nb_classes = 8142
