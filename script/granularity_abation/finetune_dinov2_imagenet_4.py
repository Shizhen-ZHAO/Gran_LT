...
def run_dinov2_imagenetlt():
    T = Trainer()
    T.task = 'run_dinov2_imagenetlt_granularity_all_au_lr875_mask_type_no_fm_remove_normal_neg_contrastive_tune'
    T.note = 'run_dinov2_imagenetlt_granularity_all_au_lr875_mask_type_no_fm_remove_normal_neg_contrastive_tune'
