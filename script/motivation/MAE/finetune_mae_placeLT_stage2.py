...
def run_placelt():
    T = Trainer()
    T.task = 'run_mae_place_CE_loss_stage2'
    T.note = 'run_mae_place_CE_loss_stage2'
    T.ckpt = './ckpt/run_mae_place_CE_loss_stage1/Place/vit_base_patch16/run_mae_place_CE_loss_stage1/checkpoint.pth'
