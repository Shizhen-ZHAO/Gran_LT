...
def run_dinov2_placelt():
    T = Trainer()
    T.task = 'run_dinov2_placelt_CE_stage_2'
    T.note = 'run_dinov2_placelt_CE_stage_2'
    T.ckpt = '/home/szzhao/LT_project/vit_LT/ckpt/run_dinov2_placelt_CE_stage_1/Place/vit_base_patch14_dinov2/run_dinov2_placelt_CE_stage_1/checkpoint.pth'
