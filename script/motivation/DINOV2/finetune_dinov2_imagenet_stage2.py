...
def run_dinov2_imagenetlt():
    T = Trainer()
    T.task = 'run_dinov2_imagenetlt_CE_stage_2'
    T.note = 'run_dinov2_imagenetlt_CE_stage_2'
    T.ckpt = './ckpt/run_dinov2_imagenetlt_CE_stage_1/ImageNet-LT/vit_base_patch14_dinov2/run_dinov2_imagenetlt_CE_stage_1/checkpoint.pth'
