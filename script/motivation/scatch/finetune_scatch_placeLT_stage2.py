...
def run_dinov2_placelt():
    T = Trainer()
    T.task = 'run_scatch_placelt_CE_stage_2'
    T.note = 'run_scatch_placelt_CE_stage_2'
    T.ckpt = './ckpt/run_scatch_placelt_CE/Place/vit_base_patch14_dinov2/run_scatch_placelt_CE/checkpoint.pth'
