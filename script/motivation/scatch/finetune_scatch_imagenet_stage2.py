...
def run_dinov2_imagenetlt():
    T = Trainer()
    T.task = 'run_scratch_imagenetlt_CE_stage_2'
    T.note = 'run_scratch_imagenetlt_CE_stage_2'
    T.ckpt = './ckpt/run_scatch_imagenet_CE/ImageNet-LT/vit_base_patch14_dinov2/run_scatch_imagenet_CE/checkpoint.pth'
