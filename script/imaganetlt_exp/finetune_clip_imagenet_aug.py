...
#     T = Trainer()
#     T.task = 'run_clip_imagenetlt_aug_4'
#     T.note = 'run_clip_imagenetlt_aug_4'
#     T.ckpt = ''
#
...
# def run_clip_imagenetlt():
#     T = Trainer()
#     T.task = 'run_clip_imagenetlt_aug_8'
#     T.note = 'run_clip_imagenetlt_aug_8'
#     T.ckpt = ''
#
#     T.dataset = 'ImageNet-LT'
#     T.nb_classes = 1000
...
def run_clip_imagenetlt():
    T = Trainer()
    T.task = 'run_clip_imagenetlt_aug_15'
    T.note = 'run_clip_imagenetlt_aug_15'
    T.ckpt = ''
